...
最終更新: **2026-05-27**（Loop 19 — `decisions.jsx → src/decisions.tsx` ESM port 着地）
...
| 🖥️ Frontend | 🟡 95% | `93a4778` | Vite scaffold ✅／Phase 1 `api.ts` + `charts.tsx` + `data.ts` + `decisions.tsx` ESM 化 ✅／残: dashboard.jsx / app.jsx の ESM 移植 ／E2E |
