...
const ETL_JOB_META: Record<
  number,
  { source: string; dataItems: string; url: string }
> = {
  1: {
    source: "気象庁 AMeDAS",
...
export const ReportsPage: FC = () => {
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      <div className="card mb-16">
        <div className="card-header">
          <span className="card-title">レポート生成</span>
        </div>
        <div className="card-body">
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    template: e.target.value as ReportTemplate,
                  }))
                }
              >
      ...
      <div className="card">
        <div className="card-header">
          <span className="card-title">最近のレポート</span>
        </div>
        <table className="data-table">
          <thead>
            <tr>
          ...
          <tbody>
            {RECENT_REPORTS.map((r, i) => (
              <tr key={i}>
                ...
                <td>{r.target}</td>
                <td>
                  <span className="badge badge-neutral">{r.fmt}</span>
                </td>
                <td>
                  <button className="btn btn-sm">📥 再ダウンロード</button>
                </td>
              </tr>
            ))}
          </tbody>
...
export const AuditPage: FC = () => {
  ...
  const filtered = useMemo(
    () =>
      filterAction === "all"
        ? displayLogs
        : displayLogs.filter((l) => l.action === filterAction),
  ...
  const handleExportHtml = () => {
    ...
    const filterMeta =
      filterAction !== "all" ? ` / フィルタ: ${esc(filterAction)}` : "";
    ...
    <div>
      <div className="flex-between mb-16">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button className="btn btn-sm" onClick={handleExportHtml}>
            🌐 HTML
          </button>
...
export const SettingsPage: FC<SettingsProps> = ({ role }) => {
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <div className="card mb-16">
        <div className="card-header">
          <span className="card-title">ユーザー設定</span>
        </div>
        <div className="card-body">
          <div className="grid-2">
            <div className="form-group">
      ...
      <div className="card mb-16">
        <div className="card-header">
          <span className="card-title">通知設定</span>
        </div>
        <div className="card-body">
      ...
      <div className="card mb-16">
        <div className="card-header">
          <span className="card-title">データ保持期間</span>
        </div>
        <div className="card-body">
          <div className="grid-2">
            <div className="form-group">
...
export const AiSettingsPage: FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (resp.ok) {
        ...
        setSaveResult(
          `設定を保存しました。キー: ${data.key_preview || "(削除)"}`,
        );
        // 設定を再読込
        loadSettings();
        setApiKey(""); // 入力欄クリア
  ...
  const supportedModels =
    settings?.supported_models ?? DEFAULT_SUPPORTED_MODELS;
