...
// dashboard.tsx, weather-marine.tsx, analysis.tsx, admin-pages.tsx,
// site-pages.tsx, and app-shell.tsx assign window.* globals on load.
// The named imports above pin each module into the bundle so Rollup
...
export function App() {
  return (
    <main style={{
      ...
      <p style={{ color: '#6b7280', marginTop: 0 }}>Phase 1 (api.ts + charts.tsx + data.ts + decisions.tsx + dashboard.tsx + weather-marine.tsx + analysis.tsx + admin-pages.tsx + site-pages.tsx + app-shell.tsx — <strong>Phase 1 完了</strong>).</p>
      <section style={{
        background: '#fef3c7',
      ...
      <section style={{
        ...
        <div style={{ color: '#6b7280', marginTop: 4 }}>
          ...
          <code>window.SiteRegisterPage</code> / <code>window.SiteDetailPage</code> /
          <code>window.App</code> / <code>window.SvgIcon</code> / <code>window.NAV_ITEMS</code> /
          <code>window.PAGE_TITLES</code> etc.)
        </div>
      </section>
    </main>
  );
